...
from numpy import array, zeros, concatenate, searchsorted, exp, diff
...
class GridGenerator(object):
    def __init__(self, equilibrium = None, core_flux_grid = None, pfr_flux_grid = None, outer_sol_flux_grid = None,
        ...
        m = (-1.68 + 2.06) / (1.73 - 1.35)
        c = -2.06 - m*1.35

        inner_leg.condition = self.bound_poly.is_inside
        outer_leg.condition = lambda x :  (x[1] > -2.06) and (x[1] > m*x[0] + c) # self.bound_poly.is_inside
